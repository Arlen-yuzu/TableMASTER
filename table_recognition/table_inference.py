...
import os 
os.environ['PYTHONPATH']='/fm1/wangziwei/wzw/TableMASTER-mmocr-master'
...
from .utils import detect_visual, end2end_visual, structure_visual, coord_convert, clip_detect_bbox, rectangle_crop_img, delete_invalid_bbox
...
class Recognition_Inference(Inference):
    def __init__(self, config_file, checkpoint_file, device='cpu', samples_per_gpu=64):
        self.config_file = config_file
        self.checkpoint_file = checkpoint_file
        super().__init__(config_file, checkpoint_file, device)
...
class End2End:
    ...
    def predict(self, file_path):
        ...
        img = imread(file_path)
        if len(detect_results[0]['bbox']) != 0:
...
class Structure_Recognition(Inference):
    def __init__(self, config_file, checkpoint_file, device='cpu', samples_per_gpu=4):
        self.config_file = config_file
        self.checkpoint_file = checkpoint_file
        super().__init__(config_file, checkpoint_file, device)
        self.samples_per_gpu = samples_per_gpu
...
if __name__ == '__main__':
    ...
    task_id = 0
    cfg = {
        'pse_config': '/fm1/wangziwei/wzw/TableMASTER-mmocr-master/configs/textdet/psenet/psenet_r50_fpnf_600e_pubtabnet.py',
        'master_config': '/fm1/wangziwei/wzw/TableMASTER-mmocr-master/configs/textrecog/master/master_ResnetExtra_tableRec_dataset_dynamic_mmfp16.py',
        'structure_master_config': '/fm1/wangziwei/wzw/TableMASTER-mmocr-master/configs/textrecog/master/table_master_ResnetExtract_Ranger_0705.py',
        'pse_ckpt': '/fm1/wangziwei/wzw/TableMASTER-mmocr-master/checkpoints/pse_epoch_600.pth',
        'master_ckpt': '/fm1/wangziwei/wzw/TableMASTER-mmocr-master/checkpoints/master_epoch_6.pth',
        'structure_master_ckpt': '/fm1/wangziwei/wzw/TableMASTER-mmocr-master/checkpoints/table_master.pth',
        'end2end_result_folder': '/fm1/wangziwei/wzw/TableMASTER-mmocr-master/results_wzw/end2end_val_result',
        'structure_master_result_folder': '/fm1/wangziwei/wzw/TableMASTER-mmocr-master/results_wzw/structure_val_result',

        'test_folder': '/fm1/wangziwei/wzw/TableMASTER-mmocr-master/mmocr_pubtabnet_recognition_val_toy/',
