...
if __name__ == "__main__":
    # detection
    subprocess.call("CUDA_VISIBLE_DEVICES=0 python -u ./table_inference.py 8 0 0 &", shell=True)
    ...
    # structure
    subprocess.call("CUDA_VISIBLE_DEVICES=0 python -u ./table_inference.py 8 0 2 &", shell=True)
    ...
    # recognition
    subprocess.call("CUDA_VISIBLE_DEVICES=0 python -u ./table_inference.py 8 1 1", shell=True)
