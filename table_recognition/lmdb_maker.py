...
def parse_tablemaster_args():
    ...
    parser.add_argument('--lmdb-root', type=str, default='/data/xuyilun/project/tsrbenchmark/models/TableMASTER/datasets/icdar13_lmdb', help='lmdb output path.')
    ...
    parser.add_argument('--txt-folder', type=str, default='/data/xuyilun/project/TableMASTER/table_recognition/mmocr_pubtabnet_recognition_icdar13/StructureLabelAddEmptyBbox_train', help='TableMASTER txt folder.')
    parser.add_argument('--img-root', type=str, default='/data/xuyilun/project/TableMASTER/datasets/icdar13', help='pubtabnet dataset imgs root.')
...
def parse_master_args():
   ...
   # parser.add_argument('--lmdb-root', type=str, default='/data_0/dataset/processed_data/lmdb/',
    ...
    parser.add_argument('--map-size', type=int, default=1099511627776, help='map size of lmdb.')
    parser.add_argument('--txt-root', type=str, default='/data/xuyilun/project/tsrbenchmark/models/TableMASTER/table_recognition/mmocr_pubtabnet_recognition_icdar13', help='MASTER txts root.')
    parser.add_argument('--img-root', type=str, default='/data/xuyilun/project/tsrbenchmark/models/TableMASTER/table_recognition/mmocr_pubtabnet_recognition_icdar13', help='text-line cropped imgs root.')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--map-size', type=int, default=1099511627776, help='map size of lmdb.')
    parser.add_argument('--split', type=str, default='train', help='train or val phase.')
    parser.add_argument('--lmdb-root', type=str, default='/shared/aia/alg/xyl/tsrdataset/model/tablemaster/icdar13/icdar13_lmdb', help='lmdb output path.')
    parser.add_argument('--txt_folder', type=str, default='/shared/aia/alg/xyl/tsrdataset/model/tablemaster/icdar13/StructureLabelAddEmptyBbox_test')
    parser.add_argument('--img-root', type=str, default='/shared/aia/alg/xyl/tsrdataset/unify/icdar13/image', help='pubtabnet dataset imgs root.')
    args = parser.parse_args()
    # args = parse_tablemaster_args()
    
    if not os.path.exists(args.lmdb_root):
        os.makedirs(args.lmdb_root)
    ...
    #lmdb_path = '/data/xuyilun/project/tsrbenchmark/models/TableMASTER/datasets/icdar13_lmdb'
    #coding = 'utf8'
    #env = lmdb.open(
     #   lmdb_path,
      #  max_readers=1,
