...
#alphabet_file = '/fm1/wangziwei/wzw/TableMASTER-mmocr-master/mmocr_pubtabnet_recognition_val_toy/textline_recognition_alphabet.txt'
...
img_prefix1 = ''
train_anno_file1 = '/data_0/dataset/processed_data/lmdb/MasterRecLabel_train/'
train1 = dict(
    type=dataset_type,
    img_prefix=img_prefix1,
    ann_file=train_anno_file1,
    loader=dict(
        type='MASTERLmdbLoader',
        repeat=1,
        parser=dict(
            type='MASTERLmdbParser',
            keys=['filename', 'text'],
            keys_idx=[0, 1],
            separator='\t')),
