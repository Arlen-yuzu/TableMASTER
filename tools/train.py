...
def main():
    ...
    cfg.data.train.datasets[0].update(img_prefix=cfg.train_img_prefix, ann_file=cfg.train_anno_file1)
    cfg.data.val.datasets[0].update(img_prefix=cfg.valid_img_prefix, ann_file=cfg.valid_anno_file1)
    cfg.data.test.datasets[0].update(img_prefix=cfg.test_img_prefix, ann_file=cfg.test_anno_file1)
